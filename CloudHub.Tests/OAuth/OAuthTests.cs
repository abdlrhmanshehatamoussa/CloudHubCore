    ...
    public class OAuthTests
    {
        ...
        public void UnRegisteredOAuthExtractor()
        {
            Exception? ex = Assert.ThrowsAsync<Exception>(async () =>
            {
                ...
                OAuthUser? user = await oAuthService.GetUserByToken(testToken, LoginTypeValues.LOGIN_TYPE_FACEBOOK);
            });
        ...
        public void HappyScenarioGoogle()
        {
            Assert.DoesNotThrowAsync(async () =>
            {
                ...
                OAuthUser? user = await oAuthService.GetUserByToken(testToken, LoginTypeValues.LOGIN_TYPE_GOOGLE);
