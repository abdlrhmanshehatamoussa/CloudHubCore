...
namespace CloudHub.Infra.Services
{
    ...
    public class OAuthService : IOAuthService
    {
        public OAuthService()
        {
            this.Extractors.Add(LoginTypeValues.LOGIN_TYPE_GOOGLE, new GoogleOAuthExtractor());
        }

        private readonly Dictionary<LoginTypeValues, IOAuthExtractor> Extractors = new Dictionary<LoginTypeValues, IOAuthExtractor>();
