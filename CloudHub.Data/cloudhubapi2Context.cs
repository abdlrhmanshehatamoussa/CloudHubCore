...
{
    public partial class cloudhubapi2Context : DbContext
    {
        public cloudhubapi2Context()
        {
        }

        public cloudhubapi2Context(DbContextOptions<cloudhubapi2Context> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<ClientsApplication> ClientsApplications { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseNpgsql("Host=127.0.0.1;Database=cloudhub-api2;Username=postgres;Password=123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ClientsApplication>(entity =>
            {
